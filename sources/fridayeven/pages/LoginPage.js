...
const  LoginPage = ({fetchUserDetails,getparticularuser,userpost,userinfo})=> {
  ...
  return (
    <div className="disp_con">
        ...
        <div className="body_container">
            ...
            <div><p className="legal_info">By continuing, you agree to According to Digital <span className="span_color">Conditions of Use</span> and <span className="span_color">Privacy Notice.</span></p></div>
            </div>
